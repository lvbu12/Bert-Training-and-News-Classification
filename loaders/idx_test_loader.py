...
class TestData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return words_idx, sent_idx, mask_index
...
#    print('maxlen of lin = ', maxlen)
    ...
    for words_t, words_num_t, sent_t, mask_index_t, mask_num_t in loader:
        print(words_t)
        print(words_num_t)
        print(sent_t)
        print(mask_index_t)
        print(mask_num_t)
        print(words_t.size(), words_num_t.size(), sent_t.size(), mask_index_t.size(), mask_num_t.size())
        break
